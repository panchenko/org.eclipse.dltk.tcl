...
public class GroupImpl extends EObjectImpl implements Group {
	...
	protected EClass eStaticClass() {
		return DefinitionsPackage.Literals.GROUP;
	}
	...
	public void setLowerBound(int newLowerBound) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DefinitionsPackage.GROUP__LOWER_BOUND, oldLowerBound, lowerBound));
	}
	...
	public void setUpperBound(int newUpperBound) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DefinitionsPackage.GROUP__UPPER_BOUND, oldUpperBound, upperBound));
	}
	...
	public void setConstant(String newConstant) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DefinitionsPackage.GROUP__CONSTANT, oldConstant, constant));
	}
	...
	public EList<Argument> getArguments() {
		if (arguments == null) {
			arguments = new EObjectContainmentEList<Argument>(Argument.class, this, DefinitionsPackage.GROUP__ARGUMENTS);
		}
		return arguments;
	}
