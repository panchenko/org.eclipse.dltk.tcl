 ...
 * @generated
 */
public class TypedArgumentImpl extends EObjectImpl implements TypedArgument {
	/**
	...
	protected EClass eStaticClass() {
		return DefinitionsPackage.Literals.TYPED_ARGUMENT;
	}
	...
	public void setLowerBound(int newLowerBound) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DefinitionsPackage.TYPED_ARGUMENT__LOWER_BOUND, oldLowerBound, lowerBound));
	}
	...
	public void setUpperBound(int newUpperBound) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DefinitionsPackage.TYPED_ARGUMENT__UPPER_BOUND, oldUpperBound, upperBound));
	}
	...
	public void setType(ArgumentType newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DefinitionsPackage.TYPED_ARGUMENT__TYPE, oldType, type));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DefinitionsPackage.TYPED_ARGUMENT__NAME, oldName, name));
	}
