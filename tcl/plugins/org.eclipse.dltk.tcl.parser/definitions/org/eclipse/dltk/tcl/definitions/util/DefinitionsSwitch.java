...
public class DefinitionsSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case DefinitionsPackage.COMMAND: {
				Command command = (Command)theEObject;
				T result = caseCommand(command);
				if (result == null) result = caseScope(command);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DefinitionsPackage.SCOPE: {
				Scope scope = (Scope)theEObject;
				T result = caseScope(scope);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DefinitionsPackage.CONSTANT: {
			...
			case DefinitionsPackage.GROUP: {
				Group group = (Group)theEObject;
				T result = caseGroup(group);
				if (result == null) result = caseArgument(group);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case DefinitionsPackage.TYPED_ARGUMENT: {
			...
			case DefinitionsPackage.NAMESPACE: {
			...
			case DefinitionsPackage.COMPLEX_ARGUMENT: {
				ComplexArgument complexArgument = (ComplexArgument)theEObject;
				T result = caseComplexArgument(complexArgument);
				if (result == null) result = caseArgument(complexArgument);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Complex Argument</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Complex Argument</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseComplexArgument(ComplexArgument object) {
		return null;
	}
