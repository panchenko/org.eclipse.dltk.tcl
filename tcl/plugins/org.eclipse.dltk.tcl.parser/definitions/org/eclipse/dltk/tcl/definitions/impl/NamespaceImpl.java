...
public class NamespaceImpl extends ScopeImpl implements Namespace {
	...
	protected EClass eStaticClass() {
		return DefinitionsPackage.Literals.NAMESPACE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DefinitionsPackage.NAMESPACE__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DefinitionsPackage.NAMESPACE__NAME:
				return getName();
		}
