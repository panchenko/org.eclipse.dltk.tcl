...
public class ScopeImpl extends EObjectImpl implements Scope {
	...
	protected EClass eStaticClass() {
		return DefinitionsPackage.Literals.SCOPE;
	}
	...
	public EList<Scope> getChildren() {
		if (children == null) {
			children = new EObjectContainmentEList<Scope>(Scope.class, this, DefinitionsPackage.SCOPE__CHILDREN);
		}
		return children;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DefinitionsPackage.SCOPE__CHILDREN:
