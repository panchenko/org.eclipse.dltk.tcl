 ...
 * </copyright>
 *
 * $Id: MessagesAdapterFactory.java,v 1.1 2009/01/27 18:43:45 apanchenk Exp $
 */
...
public class MessagesAdapterFactory extends AdapterFactoryImpl {
	...
	protected MessagesSwitch<Adapter> modelSwitch =
		new MessagesSwitch<Adapter>() {
			@Override
			public Adapter caseCheckerMessage(CheckerMessage object) {
				return createCheckerMessageAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.dltk.tcl.tclchecker.model.messages.CheckerMessage <em>Checker Message</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.dltk.tcl.tclchecker.model.messages.MessageGroup <em>Message Group</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
