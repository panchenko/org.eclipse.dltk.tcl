...
public class IndentationOffTest extends ScriptedTest {

	@SuppressWarnings("nls")
	public static TestSuite suite() {
		final IndentationOffTest tests = new IndentationOffTest();
		...
		tests.setPreference(TclFormatterConstants.FORMATTER_INDENTATION_SIZE,
				new Integer(3));
		tests.setPreference(TclFormatterConstants.INDENT_SCRIPT, false);
		tests
				.setPreference(TclFormatterConstants.INDENT_AFTER_BACKSLASH,
						false);
		return tests.createScriptedSuite(FContext.CONTEXT,
				"scripts/indentation-off-tests.tcl");
	}
