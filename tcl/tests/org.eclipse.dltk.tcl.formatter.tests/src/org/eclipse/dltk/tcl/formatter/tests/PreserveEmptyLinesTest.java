...
public class PreserveEmptyLinesTest extends ScriptedTest {

	@SuppressWarnings("nls")
	public static TestSuite suite() {
		return new PreserveEmptyLinesTest().createScriptedSuite(
				FContext.CONTEXT, "scripts/preserve-empty-lines.tcl");
	}
}
